					...
					foreach( $my_posts as $post ){
						setup_postdata( $post ); ?>
                               <li class="page-loop__item wow animate__animated animate__fadeInUp" data-wow-duration="0.8s">
                                    ...
                                    <a href="<?php echo get_permalink(); ?>" class="page-loop__item-link">
                                        ...
                                        <div class="page-loop__item-image">
                                            ...
                                            <div class="page-loop__item-badges">
                                                <span class="badge"><?php the_field('service_1');?></span>
                                                <span class="badge"><?php the_field('service_2');?></span>
                                            </div>
                                        ...
                                        <div class="page-loop__item-info">
                                            ...
                                            <p class="page-text"><?php the_field('date');?></p>

                                            <div class="page-text to-metro">
                                                <span class="icon-metro icon-metro--red"></span>
                                                <span class="page-text"><?php the_field('address');?></span>
                                                <span class="icon-walk-icon"></span>
                                            </div>

                                            <span class="page-text text-desc"><?php the_field('address_full');?></span>
