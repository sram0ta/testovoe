...
add_action( 'wp_enqueue_scripts', 'min_style', 25 );
 
function min_style() {
 	wp_enqueue_style( 'min-css', get_stylesheet_directory_uri() . '/assets/css/style.css' );
 	wp_enqueue_style( 'icon-font', get_stylesheet_directory_uri() . '/assets/fonts/icomoon/icon-font.css' );
 	wp_enqueue_style( 'animate-css', get_stylesheet_directory_uri() . '/assets/libs/animate/animate.min.css' );
	wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-2.2.4.min.js');
	wp_enqueue_script('bootstrap_popper', get_template_directory_uri() . '/assets/libs/bootstrap/js/popper.min.js');
	wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/libs/bootstrap/js/bootstrap.min.js');
	wp_enqueue_script('ofi', get_template_directory_uri() . '/assets/libs/ofi/ofi.min.js');
	wp_enqueue_script('wow', get_template_directory_uri() . '/assets/libs/wowjs/wow.min.js');
	wp_enqueue_script('scripts', get_template_directory_uri() . '/assets/js/scripts.js');
	wp_enqueue_script('nav', 'https://api-maps.yandex.ru/2.1/?apikey=f7f5866c-fcab-4da8-94d7-cdbdb39c7d22&lang=ru_RU');
};